...
\begin{frame}{Demo: RNN dự đoán giá cổ phiếu}
    \begin{columns}[T,totalwidth=\textwidth]
        ...
        \begin{itemize}
            \item RMSE $\approx 1.45$
            \item MAE $\approx 1.19$
        \end{itemize}
        \vspace{0.5em}
        \textbf{Ghi chú}
        \begin{itemize}
            \item Chuỗi synthetic: sóng sin + nhiễu, 320 điểm train / 100 điểm test.
            \item Dự báo dùng tham số đã huấn luyện; không dùng thêm thông tin test.
        \end{itemize}
    \end{columns}
\end{frame}
